...
class EthdebugFormatPointerCollectionScope(BaseModel):
    ...
    define: Dict[constr(pattern=r'^[a-zA-Z_\-]+[a-zA-Z0-9$_\-]*$'), Expression] = Field(
        ..., title='Mapping of variables to expression value'
    )
    in_: Pointer = Field(..., alias='in')
...
EthdebugFormatPointerCollectionScope.model_rebuild()
