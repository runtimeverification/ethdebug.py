...
class Segment(BaseModel):
    slot: Expression
    offset: Optional[Expression] = Field(
        0,
    ...
    length: Optional[Expression] = Field(
        default_factory=lambda: Expression.model_validate(
...
EthdebugFormatPointerRegionStorage.model_rebuild()
